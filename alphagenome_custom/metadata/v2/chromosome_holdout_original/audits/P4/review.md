...
Reviewed at: `2026-07-15T10:19:54+00:00`

| Check | Status | Evidence |
| --- | --- | --- |
| R4.01_required_outputs | PASS | missing=[] |
| R4.02_five_fold_split | PASS | errors=[] chromosomes=['I', 'II', 'III', 'IV', 'V'] |
| R4.03_nonoverlapping_eval_cores | PASS | core_errors=[] test_valid=True |
...
| R4.08_test_embargo | PASS | default_loader_refused=True test_windows=33 |
| R4.09_io_benchmark | PASS | window_seconds=2.6341048111207783 target_bytes=1018724352 |
