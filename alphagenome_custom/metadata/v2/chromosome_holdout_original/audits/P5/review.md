...
Reviewed at: `2026-07-15T10:33:33+00:00`

| Check | Status | Evidence |
| --- | --- | --- |
| R5.01_required_outputs | PASS | missing=[] |
| R5.02_leakage_safe_track_means | PASS | tracks=241 x_read=False |
| R5.03_model_space_scaling_and_dual_loss | PASS | head_shapes={'1': [1, 241, 1024], '128': [1, 241, 8]} loss=26.312782287597656 |
...
| R5.09_unit_and_golden_tests | PASS | unit_tests=56 return=0 |
| R5.10_test_embargo | PASS | prohibited_until_locked_G5_P6C |
